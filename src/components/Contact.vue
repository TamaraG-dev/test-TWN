...
// Ensuite, pour utiliser des variables dans une mutation, cette syntaxe n'est pas correcte : 
// 
...
// Je te laisse modifier la partie delete contact ;)
// Il faudra surement que tu revois ta logique pour déterminer quel contact tu veux supprimer
// tu peux par exemple définir ta mutation en dehors de ta fonction deleteContact, laisser la logique dedans et ensuite appeler ta mutation depuis cetet fonction
